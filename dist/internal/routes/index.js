import { Compass, PaintRoller, Sticker } from "@steeze-ui/phosphor-icons";
import { progressVariants } from "../../components/progress/index.ts";
import { buttonVariants } from "../../components/button/index.ts";
import { keyboardVariants } from "../../components/kbd/index.ts";
import { noiseVariants } from "../../components/noise/index.ts";
import { alertVariants } from "../../components/alert/alert.svelte";
export const docs = {
    title: "Docs",
    items: [
        {
