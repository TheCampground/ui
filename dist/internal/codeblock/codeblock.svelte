<script lang="ts">
    import { ShikiHandler } from "../shiki/index.ts"
...
<div class="flex justify-center w-full overflow-hidden! z-2 relative">
    <div class="flex w-full flex-col rounded-xl border overflow-hidden! h-fit mb-auto z-2">
        <div class="flex flex-col w-full text-sm">
            <div class={cn(
                ...
                <Button
                    variant="ghost"
                    size="icon"
                    class={cn("size-8", filename ? "mr-1" : "absolute top-[5px] right-[5px] backdrop-blur-lg")}
